  ...
  return (
    <section className="border-2 border-gray-600 shadow-gray-400 shadow-sm mx-10 mt-32 px-4 py-3 rounded-xl">
      <div className="mx-auto px-4 container">
        <h2 className="mb-8 font-bold font-instrumentSans text-6xl text-center text-gray-300 italic tracking-widest">
          Experience
        </h2>
        <div className="gap-8 grid sm:grid-cols-1 md:grid-cols-2">
          {experiences.map((exp, index) => (
            <div
              key={index}
              className="bg-custom-gray shadow-md hover:shadow-lg p-6 rounded-lg transition-shadow duration-300"
            >
              <h3 className="font-light text-2xl text-gray-300 italic tracking-widest">
                {exp.role}
              </h3>
