            ...
            >
              <figure>
                <img
                  ...
                  alt={`Banner image for project: ${project.title}`} // Add descriptive alt text
                />
                <figcaption className="absolute inset-0 flex flex-col justify-center items-center gap-2 bg-black/35 transition-transform translate-y-full group-hover:translate-y-0 duration-300">
